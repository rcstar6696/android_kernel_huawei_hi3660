...
#if defined (CONFIG_MALI_PLATFORM_HI3660) || defined (CONFIG_MALI_PLATFORM_KIRIN660)
#define G3DAUTOCLKDIVBYPASS             0x268
#define VS_CTRL_2                       0x46c
#elif defined (CONFIG_MALI_PLATFORM_KIRIN970)
#define G3DAUTOCLKDIVBYPASS             0x268
#define VS_CTRL_2                       0x418
#elif defined (CONFIG_MALI_PLATFORM_KIRIN980)

 ...
 ******************************************************************************
  ...
  1.日    期   : 2017年1月17日
    作    者   : s00184266
    修改原因   : dts2017011204014, 增加DESCRIPTION字段描述
...
/*****************************************************************************
 ...
 DESCRIPTION: GSM自主重定向到LTE的LTE频点测量配置
 修改历史  :
 1.日    期    : 2013年08月05日
   作    者    : y00142674
...
/*****************************************************************************
 结构名    : NVIM_GAS_MNTN_CHR_DIRECT_RPT_CONFIG_STRU
 结构说明  : GAS CHR直通上报相关的NV配置
 修改历史  :
 1.日    期    : 2016年11月08日
   作    者    : y00383718
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: en_NV_Item_GAS_UTRAN_TDD_DEFAULT_Q_RXLMIN NV结构 网络没有配置
              基于优先级的 UTRAN 重选参数时, 默认的 UTRAN TDD Q_RXLMIN. 仅在基于
              优先级重选时使用. 基于 Ranking 的默认重选门限是 -90dB, 不需要定制
 修改历史  :
 1.日    期    : 2014年12月20日
...
/*****************************************************************************
 ...
 DESCRIPTION: C1计算优化网络白名单(目前仅在L CSFB G流程中使用)
 修改历史  : 
 1.日    期    : 2015年02月06日
   作    者    : y00265681
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 定制PLMN的GSM BAND信息。在指定的生效场景下，仅搜索定制的BAND，提高搜网效率。
 修改历史  : 
 1.日    期    : 2015-04-23
   作    者    : p00166345
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 定制GSM小区在BCCH上接收到的历史系统消息的使用配置
 修改历史  : 
 1.日    期    : 2015-05-06
   作    者    : p00166345
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 结构说明  : H_PRIO使用场景定制配置 
 DESCRIPTION: G模到异系统基于优先级重选的H_Prio准则定制配置
 修改历史  : 
 1.日    期    : 2015年05月17日
   作    者    : w00146666
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 用于定制 RR 随机接入失败后是否快速给 NAS 上报丢网
 修改历史  : 
 1.日    期    : 2015年05月15日
   作    者    : p00166345
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 DESCRIPTION: 用于配置在具体场景下是否可以启动自主 FR.
 修改历史  : 
 1.日    期    : 2015-06-09
   作    者    : p00166345
   修改内容    : 新建结构体
...
/*****************************************************************************
 ...
 2.日    期   : 2017年1月13日
   作    者   : s00184266
   修改原因   : dts2017011012871, 增加NV项，用以低优先级判决中，等待所有邻区解码完成才进行裁决
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 DESCRIPTION: 运营商定制的GSM频点列表，由PLMN、BAND、起始频点、终止频点、离散频点
 修改历史  :
  1.日  期   : 2015年8月28日
    作  者   : s00184266
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: L2G 重定向过程中,搜索网络指定频点时使用历史频点的相关配置
 修改历史  :
  1.日  期   : 2015-10-16
    作  者   : p00166345
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 DESCRIPTION: GUAS Cellular Prefer域选上报配置定制 
 修改历史  :
  1.日  期   : 2016年9月22日
    作  者   : s00184266
    修改内容 : 新生成结构
...
/*****************************************************************************
 结 构 名  : NVIM_GAS_CSFB_FAIL_LAI_PENALTY_CFG_STRU
 结构说明  : 用于GAS CSFB失败后对目标小区进行LAI相关惩罚的配置定制 
 DESCRIPTION: 用于GAS CSFB失败后对目标小区进行LAI相关惩罚的配置定制 
 修改历史  :
  1.日  期   : 2016年12月21日
    作  者   : h00390293
    修改内容 : 新生成结构
...
/* Added by L00349911 for 3G优先级不配优化, 2017-2-24, begin */
/*****************************************************************************
 结 构 名  : NVIM_GAS_NETWORK_NOT_ALLOC_UTRAN_PRIORITY_CFG_STRU
 结构说明  : 用于GSM网络没有配置3G优先级，UE进行优化的配置定制 
 DESCRIPTION: 用于GSM网络没有配置3G优先级，UE进行优化的配置定制 
 修改历史  :
  1.日  期   : 2017年02月24日
    作  者   : L00349911
    修改内容 : 新生成结构
...
/* Added by L00349911 for 3G优先级不配优化, 2017-2-24, end */
